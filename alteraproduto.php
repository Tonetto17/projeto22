...
<div>
    ...
    <div class="formulario">
        <form class="visualizaproduto" action="alteraproduto.php" method="post">
            ...
            <br>
            <input type="radio" name="ativo" id="ativo" value="s" <?= $ativo == "s" ? "checked": ""?>><label>ATIVO</label>
            <input type="radio" name="ativo" id="ativo" value="n" <?= $ativo == "n" ? "checked": ""?>><label>INATIVO</label>
    ...
    <div>
        <!-- PEÇA ESSENCIAL PARA COLETAR A IAMGEM ATUAL -->
